...
describe('PokemonController', () => {
  ...
  it('invokes GET /pokemon with pagination', async () => {
    ...
    const res = await client
      .get(`/pokemon?filter=${JSON.stringify(filter)}`)
      .expect(200);
